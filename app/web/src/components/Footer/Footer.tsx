...
import { footerList } from 'src/base/global/footerList'

type Props = {}

const Footer = (props: Props) => {
  const newDataFooter = useGlobal(footerList).data
  const data = [1, 2, 3, 4]
  return (
    <div className="bg-green-army py-36 mt-40">
      <Container>
        <div className="flex flex-col lg:flex-row justify-between items-center">
          ...
          <div className="mt-12 lg:mt-0">
            ...
            <button className="mx-2 text-white py-3 px-8 ring-1 ring-white rounded-3xl bg-green-army font-medium">
              Schedule Meet
            </button>
          </div>
        </div>
